...
| **Husky**    |  [`^9.1`](https://www.npmjs.com/package/husky)   | _Dev Tool_  | Run scripts automatically via Git hooks                         | [Docs](https://typicode.github.io/husky/) - [How-to](https://typicode.github.io/husky/how-to.html) - [Run on Staged Files <sup>**(Lint-Staged)**</sup>](https://github.com/lint-staged/lint-staged#readme)          | [Husky](docs/js-foundation/development/gitflow-tools/husky.md) - [Lint-Staged](docs/js-foundation/development/gitflow-tools/lint-staged.md) |
